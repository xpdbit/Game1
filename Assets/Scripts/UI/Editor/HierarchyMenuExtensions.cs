...
namespace Game1.Editor
{
    ...
    public static class HierarchyMenuExtensions
    {
        ...
        public static void CreateInventory(MenuCommand menuCommand)
        {
            ...
            // 创建顶部操作栏（仅结构，无文本）
            CreateInventoryTopBarMinimal(inventoryRoot, inventory);

            // 创建底部操作栏（仅结构，无文本）
            CreateInventoryBottomBarMinimal(inventoryRoot, inventory);
        ...
        private static GameObject CreateInventoryItemTemplate(GameObject parent)
        {
            ...
            // Name Text - 只有RectTransform和TextMeshPro
            ...
            itemComponent.itemNameText = null; // 手动设置
            itemComponent.amountText = null; // 手动设置
